...
vocab_words = ds.Vocab.from_file('data/vocab.txt')
train = list(ds.read_oracle('data/amr-examples.txt', vocab_words, vocab_acts))
dev = list(ds.read_oracle('data/amr-examples-test.txt', vocab_words, vocab_acts))
